...
def envia_arquivo_unidades(diretorioArquivo, fromaddr, toaddr, nome):
    ...
    msg[
        "Subject"
    ] = "{0} - Certificado de Participação do Workshop - Bi do Zero Até o DW".format(
        nome
    )
    ...
    attachment = open(
        "{0}\Certificado_{1}.pdf".format(diretorioArquivo, nome.replace(" ", "_")), "rb"
    )
...
diretorioArquivo = (
    rf"C:\Temp\Python_YT\Git\Projeto_BI_Zero_TO_DW\03_MATERIAL_APOIO\Certificado"
)
...
dados = {
    ...
    "nome": [
        ...
        "Mateus Luís Soncin Gazola",
        "Renato Fidelis Ribeiro",
        "Wallace Camargo Pereira da Graça",
    ],
    "email": [
        "danielduarte0496@gmail.com",
        "edmagnogomes@gmail.com",
        "magazola06@gmail.com",
        "fidelisrenato8@gmail.com",
        "wallacecpdg@gmail.com",
    ]
